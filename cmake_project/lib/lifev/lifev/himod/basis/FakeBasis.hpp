 ...
 */
#ifndef __FAKEBASIS_HPP__
#define __FAKEBASIS_HPP__
...
class FakeBasis : public Basis1DAbstract
{
public:
     ...
     */
    FakeBasis() : Basis1DAbstract(), M_icurrent (0) {};
    //@}
    ...
    basisFunction( const UInt& k, const Real& rStar, const Real& tStar, 
                   const QuadratureRule* quadrulerho, MBMatrix_type phirho, const int trigFunction ) const {};
...
//!
inline
Basis1DAbstract* createFake()
{
    return new FakeBasis();
}

namespace
{
static bool registerFake = Basis1DFactory::instance().registerProduct ( "fakebasis",  &createFake);
}
