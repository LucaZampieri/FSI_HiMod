...
/*!
 *   @file ChebyshevQuadShiftNatural.hpp
...
#ifndef __CHEBYSHEVQUADSHIFTNATURAL_HPP__
#define __CHEBYSHEVQUADSHIFTNATURAL_HPP__
...
class ChebyshevQuadShiftNatural : public UneducatedBasisAbstract
{
public:
     ...
     */
    ChebyshevQuadShiftNatural() : UneducatedBasisAbstract() {};
    //@}
...
*/
    ...
    Real angularFunction( const UInt& pt, const Real& tStar, const UInt& trigFunction ) const;
...
inline
UneducatedBasisAbstract* createChebyshevQuadShiftNatural()
{
    return new ChebyshevQuadShiftNatural();
}

namespace
{
static bool registerChebyshevQuadShiftNatural = UneducatedBasisFactory::instance().registerProduct( "ChebyshevQuadShiftNatural",  &createChebyshevQuadShiftNatural );
}
