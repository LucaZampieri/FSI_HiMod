...
#ifndef __CHEBYSHEVQUADSHIFT_HPP__
#define __CHEBYSHEVQUADSHIFT_HPP__
...
class ChebyshevQuadShift : public UneducatedBasisAbstract
{
public:
     ...
     */
    ChebyshevQuadShift() : UneducatedBasisAbstract() {};
    //@}
...
inline
UneducatedBasisAbstract* createChebyshevQuadShift()
{
    return new ChebyshevQuadShift();
}

namespace
{
static bool registerChebyshevQuadShift = UneducatedBasisFactory::instance().registerProduct( "ChebyshevQuadShift",  &createChebyshevQuadShift );
}
