 ...
 */
#ifndef __EDUCATEDBASISDD_HPP__
#define __EDUCATEDBASISDD_HPP__
...
class EducatedBasisDD : public Basis1DAbstract
{
public:
     ...
     */
    EducatedBasisDD() : Basis1DAbstract(), M_icurrent (0) {};
    //@}
...
inline
Basis1DAbstract* createDD()
{
    return new EducatedBasisDD() ;
}

namespace
{
static bool registerDD = Basis1DFactory::instance().registerProduct ( "dirdir",  &createDD);
}
