...
#ifndef __ZERNIKENATURAL_HPP__
#define __ZERNIKENATURAL_HPP__
...
class ZernikeNatural : public UneducatedBasisAbstract
{
public:
     ...
     */
    ZernikeNatural() : UneducatedBasisAbstract() {};
    //@}
...
inline
UneducatedBasisAbstract* createZernikeNatural()
{
    return new ZernikeNatural();
}

namespace
{
static bool registerZernikeNatural = UneducatedBasisFactory::instance().registerProduct( "ZernikeNatural",  &createZernikeNatural );
}
