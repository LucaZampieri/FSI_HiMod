 ...
 */
#ifndef __EDUCATEDBASISRR_HPP__
#define __EDUCATEDBASISRR_HPP__
...
class EducatedBasisRR : public Basis1DAbstract
{
public:
...
inline
Basis1DAbstract* createRR()
{
    return new EducatedBasisRR();
}

namespace
{
static bool registerRR = Basis1DFactory::instance().registerProduct ( "robrob",  &createRR);
}

} //End LifeV namespace
#endif //__EDUCATEDBASISRR_HPP__
