 ...
 *   @file Robert.hpp
     @brief This file contains the interface of a two-dimensional uneducated basis
             with Robert polynomials r^k * T_j( r ) * cos( k * theta ), sin( k * theta ).

     @date 04/2014
     @author S. Guzzetti <sofia.guzzetti@gmail.com>
 */
 
#ifndef __ROBERT_HPP__
#define __ROBERT_HPP__
...
class Robert : public UneducatedBasisAbstract
{
public:
     ...
     */
    Robert() : UneducatedBasisAbstract() {};
    //@}
...
inline
UneducatedBasisAbstract* createRobert()
{
    return new Robert();
}
...
namespace
{
static bool registerRobert = UneducatedBasisFactory::instance().registerProduct( "Robert",  &createRobert );
}
